...
# temperatures = [50, 100, 200, 1000, 5000, 10000]
# iterations_list=[1500,2000]
rate_list = [0.5, 0.7, 0.8, 0.85, 0.9, 0.95, 0.97]
for i in range(len(rate_list)):

    length = len(query_nodes)
    # 设置退火算法参数
    initial_temperature = 1000
    print("当前速率", rate_list[i])
    min_temperature = 1
    cooling_rate = rate_list[i]
    iterations = 300
    cool_type = "非线性"
    size = 5
    # 初始化类
